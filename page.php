...
<body>
  <div class="container">
    <header class="header">
        <div class="brand">
            ...
            <img src="image/logoadmin.png" alt="Miu Miu Logo" class="logo">
        </div>
        <div class="uProfile">
          <a href="http://localhost/miumiu/dashboard/adminDasboard.php">
    ...
    <div class="edit">
      <a href="http://localhost/miumiu/menu%20admin/admin_page.php">Edit menu<i href="http://localhost/miumiu/menu%20admin/admin_page.php" class="bx bx-edit"></i></a>
    </div> 
  ...
  <form action="item.php" method="get" enctype="multipart/form-data" onsubmit="return validateForm()">
